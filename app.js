document.addEventListener('DOMContentLoaded', () => {
    ...
    const appData = {
        ...
        galleryItems: [
             { id: 7, category: 'men', title: 'بدلة كلاسيكية', desc: 'اكتشف أرقى مستويات الجودة والأناقة مع هذه الدشداشة الكلاسيكية العصرية! هل تبحث عن إطلالة تجمع بين الرسمية الراقية والراحة الفائقة؟ إليك الثوب الذي سيعكس ذوقك الرفيع في كل خطوة.', price: 'يبدأ من 45,000 د.ع', img: 'دشداشة.webp' },
